"""
Django settings for hrasc project.
...
SECRET_KEY = 'django-insecure-mzfvjy%!#(e(h_u50&u^jr1uhs#me_*7y(86a2rmb@d1qej+32'
...
WSGI_APPLICATION = 'hrasc.wsgi.application'
